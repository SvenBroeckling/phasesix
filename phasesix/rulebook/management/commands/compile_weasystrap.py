...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            css_path = os.path.join(settings.STATIC_ROOT, 'rulebook', 'weasystrap', 'weasystrap.css')
            ...
            self.stdout.write(self.style.SUCCESS(f'Successfully compiled WeasyStrap to {css_path}'))
