...
class WorldAdmin(ModelAdmin):
    ...
    fieldsets = [
        ...
        (_("Descriptions"), {"fields": (("description_1_de", "description_1_en"), ("description_2_de", "description_2_en"), ("description_3_de", "description_3_en"))}),
        (_("Domains and units"), {"fields": (("dns_domain_name", "session_cookie_domain"), ("info_name_cm_de", "info_name_cm_en"), ("info_name_kg_de", "info_name_kg_en")), "classes": ("collapse",)}),
...
class WikiPageAdmin(ModelAdmin):
    ...
    fieldsets = [
        (None, {"fields": (("name_de", "name_en"), ("short_name_de", "short_name_en"), "slug", ("world", "parent"), ("is_active", "ordering"))}),
...
class WikiPageGameValuesAdmin(ModelAdmin):
    ...
    fieldsets = [
        (None, {"fields": ("wiki_page", "type", ("health", "arcana", "protection", "perception"), ("actions", "quickness", "walking_range", "minimum_roll"), ("stress_test_succeeded_stress", "stress_test_failed_stress"), ("resistances", "weaknesses"))}),
    ]
...
class WikiPageGameActionAdmin(ModelAdmin):
    ...
    fieldsets = [(None, {"fields": ("wiki_page", ("name_de", "name_en"), "skill", ("effect_de", "effect_en"), "entity_work_type")})]
...
class LanguageAdmin(ModelAdmin):
    ...
    fieldsets = [
        (None, {"fields": (("name_de", "name_en"), ("country_name_de", "country_name_en"), ("group", "amount_of_people_speaking"), "extensions")}),
